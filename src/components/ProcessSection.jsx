export default function ProcessSection() {
  return (
    <section className="relative min-h-screen bg-[#f5f9ff] overflow-hidden">
      ...
      {/* SMOOTH FADE-IN FROM PREVIOUS SECTION */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[#f5f9ff] to-transparent z-10" />

      {/* CONTENT */}
      <div className="relative z-20 mx-auto max-w-6xl px-6 py-16 sm:py-20 text-center">

        {/* PILL */}
        <span className="inline-flex mb-6 items-center rounded-full border border-blue-300 bg-blue-50 px-4 py-1 text-sm font-medium text-blue-600">
          How it works?
        </span>

        {/* HEADING */}
        <h1 className="mx-auto max-w-4xl text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight tracking-tight text-black">
        ...
        {/* TIMELINE AREA */}
        <div className="relative mt-16 lg:mt-24 lg:h-[520px] max-w-[900px] mx-auto flex flex-col gap-8 lg:block">

          {/* DASHED CURVES (DESKTOP ONLY) */}
          <svg className="absolute inset-0 w-full h-full hidden lg:block" fill="none">
            <path
          ...
          {/* WEEK 1 */}
          <div className="relative lg:absolute lg:left-0 lg:top-0 w-full sm:w-[280px] rounded-3xl bg-white p-6 shadow-xl">
          ...
          {/* WEEK 2 */}
          <div className="relative lg:absolute lg:right-0 lg:top-[160px] w-full sm:w-[280px] rounded-3xl bg-white p-6 shadow-xl">
            <span className="absolute top-3 left-1/2 -translate-x-1/2 h-1.5 w-1.5 rounded-full bg-gray-400" />
          ...
          {/* WEEK 3 */}
          <div className="relative lg:absolute lg:left-0 lg:bottom-0 w-full sm:w-[280px] rounded-3xl bg-white p-6 shadow-xl">
            <span className="absolute top-3 left-1/2 -translate-x-1/2 h-1.5 w-1.5 rounded-full bg-gray-400" />
